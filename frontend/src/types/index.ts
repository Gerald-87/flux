export interface WorkSchedule {
  checkInTime: string; // Format: "HH:MM" (24-hour format)
  checkOutTime: string; // Format: "HH:MM" (24-hour format)
...
export interface User {
  ...
  isActive: boolean;
  terminalId?: string;
  assignedInventoryIds?: string[]; // Products/categories assigned to cashier
  assignedLocations?: string[]; // Locations cashier can access
  workSchedule?: WorkSchedule; // Time-based access control for cashiers
  createdAt: Date;
  lastLogin?: Date;
